...
if(isset($_POST['cmdsave_tab1']) && $_POST['txt_name']!='') {
	...
	if($result){
		...
		$arr2['link'] = ROOTHOST_WEB.'su-kien-'.$arr['alias'].'-'.$result;
		$arr2['image'] = $file;
					...
					<div class="row">
						<div class="col-md-9">
							<div  class="form-group">
								...
								<input type="text" id="txt_name" name="txt_name" class="form-control" value="" placeholder="Tên sự kiện">
							</div>
						...
						<div class="col-md-3">
							...
							<div class="form-group">
								...
								<input type="datetime-local" name="txt_sdate" class="form-control">
							</div>
