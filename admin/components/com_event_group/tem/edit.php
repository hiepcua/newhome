...
$seo_link = ROOTHOST_WEB.'su-kien-'.$row['alias'];
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Cập nhật nhóm sự kiện</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>">Bảng điều khiển</a></li>
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST.COMS;?>">Danh sách nhóm sự kiện</a></li>
					<li class="breadcrumb-item active">Cập nhật nhóm sự kiện</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
						...
						<div class="col-md-4 col-lg-3">
							<div class="form-group">
								...
								<select class="form-control" name="cbo_par" id="cbo_par">
									...
									<?php getListComboboxGEvent(0,0, $arr_childs);?>
								</select>
