...
if(isset($_POST['cmdsave_tab1']) && $_POST['txt_name']!='') {
	...
	if($result){
		...
		$arr2['link'] = ROOTHOST_WEB.'su-kien-'.$arr['alias'];
		$arr2['image'] = $file;
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Thêm mới nhóm sự kiện</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>">Bảng điều khiển</a></li>
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST.COMS;?>">Danh sách nhóm sự kiện</a></li>
					<li class="breadcrumb-item active">Thêm mới nhóm sự kiện</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
					...
					<div class="row">
						<div class="col-md-8 col-lg-9">
							<div class="form-group">
								...
								<input type="text" id="txt_name" name="txt_name" class="form-control" value="" placeholder="Tiêu đề nhóm sự kiện">
							</div>

							<div class="form-group">
								<label>Mô tả</label>
								<textarea class="form-control" name="txt_intro" placeholder="Mô tả về nhóm sự kiện..." rows="2"></textarea>
							</div>
