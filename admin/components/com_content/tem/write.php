...
if(isset($_POST["txtaction"]) && $_POST["txtaction"]!=""){
	...
	echo "<script language=\"javascript\">window.location='".ROOTHOST.COMS."/write?status=1'</script>";
}
