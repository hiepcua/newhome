...
function listTable($strwhere="",$parid=0,$level=0,$rowcount, $search=0){
	if($search == 0){
		$sql="SELECT * FROM tbl_event_group WHERE 1=1 AND par_id=$parid $strwhere";
	}else{
		$sql="SELECT * FROM tbl_event_group WHERE 1=1 $strwhere";
	}
...
$total_rows=SysCount('tbl_event_group',$strWhere);
$max_rows = 20;
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Danh sách nhóm sự kiện</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>">Bảng điều khiển</a></li>
					<li class="breadcrumb-item active">Danh sách nhóm sự kiện</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
				...
				<div class='row'>
					<div class='col-sm-3'>
						<div class='form-group'>
							<input type='text' id='txt_title' name='q' class='form-control' placeholder="Tên nhóm sự kiện..." />
						</div>
					</div>
